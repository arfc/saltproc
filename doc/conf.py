...
# -*- coding: utf-8 -*-
#
# saltproc documentation build configuration file, created by
...
latex_documents = [
  ('index', 'saltproc.tex', 'saltproc Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'saltproc', 'saltproc Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'saltproc', 'saltproc Documentation',
   'Ariel Rokem', 'saltproc', 'One line description of project.',
   'Miscellaneous'),
]
