...
def control_rod(gr_sq_neg, gr_extra_regions, inter_elem_channel, fuel_hole, fuel, moder, optimized):
...
def control_rod_channel(gr_sq_neg, gr_extra_regions, inter_elem_channel, fuel_hole, fuel, moder, optimized):
