...
dep_hist2 = (1/(24*60))*np.linspace(start_time2, end_time2, num=nsteps2, endpoint=False)
pow_hist2 = np.linspace(power_level1, power_level2, num=nsteps2, endpoint=False)
...
dep_hist3 = (1/(24*60))*np.linspace(start_time3, end_time3, num=nsteps3, endpoint=False)
...
# Convert from minutes to days
dep_hist4 = (1/(24*60))*np.linspace(start_time4, end_time4, num=nsteps4, endpoint=False)
pow_hist4 = powstep4+np.linspace(power_level2, power_level4, num=nsteps4, endpoint=False)
...
dep_hist5 = (1/(24*60))*np.linspace(start_time5, end_time5, num=nsteps5, endpoint=False)
